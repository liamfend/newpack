...
import { addStatus, operateType, communicationStatus, platformEntity, entityAction } from '~constants';
    ...
    return (<div>
      <div className="create-offer__header">
        <If condition={ this.state.operateType === addStatus.map }>
          <div role="button" tabIndex={ 0 } onClick={ this.goToPreviousStep } className="create-offer__back-btn">
            <Icon type="left" />
