...
import {
  IconReconciliationAssign as IconReconciliationAssignIcon,
  IconReconciliationReader as IconReconciliationReaderIcon,
  IconEdit as IconEditIcon,
...
const Index = ({ match }) => {
  ...
  return opportunityDetail ? <div className="reconciliation-booking">
                  ...
                  <If condition={ showLogicManualCase(lastNote) }>
                    <span className="booking-card__extra-container">
                      ...
                      >
                        ...
                        >
                          <IconReconciliationAssignIcon className="reconciliation-booking__assign-icon" />
                        </button>
                      </Popconfirm>
                    </span>
                  </If>
      ...
      <div className="reconciliation-booking__content" id="booking_details">
            ...
            extra={
              <span className="booking-card__extra-container">
                <span className="booking-card__extra-remider">
                  <IconReconciliationReaderIcon className="booking-card__extra-icon" />
                ...
                >
                  <IconEditIcon className="editor-icon" />
                </button>
              </span>
            }
          >
        ...
        <If condition={get(opportunityDetail, 'secondaryLandlordBookingStatus') !== secondaryLandlordBookingStatus.CASE_CLOSED}>
          <div className="booking-userinfo">
            <Card bordered={ false }>
              <Card.Meta
                avatar={ <AccountPhotoIcon className="account-photo-icon" /> }
