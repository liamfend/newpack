...
export const createLandlord =
  ...
  dispatch => {
    ...
    if (formatParams.bookingJourney && formatParams.bookingJourney !== 'SEMI_AUTOMATIC') {
...
export const getPropertiesByLandlordSlug = params => dispatch => {
  fetch({
    ...
    params: queries.getPropertiesByLandlordSlug(
      formatSimpleParams(
        {
          pageNumber: 1,
          pageSize: 10,
...
export const searchPropertyNameList =
  (params, successCallback = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
...
export const getDisplayCountryList =
  (successCallback = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
...
export const bindAutoConfirmSettings =
  (params, successCallback = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
...
export const getSystemProviderList =
  (successCallback = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
...
export const getReconciliationPreferenceList =
  (successCallback = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
