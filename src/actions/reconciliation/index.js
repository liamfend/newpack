...
export const listReconciliationLandlords = params => (dispatch) => {
  ...
  fetch({
    ...
    params: queries.listReconciliationLandlords(formatSimpleParams(
      {
        pageNumber: 1,
        pageSize: 10,
...
export const getReconciliationBulkUpdateRecords = params => (dispatch) => {
  ...
  fetch({
    dispatch,
    endpoint: endpoints.defaultUrl.url(),
    params: reconciliationQueries.listReconciliationBulkUpdateRecords(formatSimpleParams(
      {
        pageNumber: 1,
        pageSize: 10,
