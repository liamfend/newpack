...
export const listOrderTransfers = params => dispatch => {
  fetch({
    ...
    params: queries.listOrderTransfers(
      formatSimpleParams(
        {
          pageNumber: 1,
          pageSize: 10,
...
export const orderTransfer = params => dispatch => {
  fetch({
    dispatch,
    endpoint: endpoints.defaultUrl.url(),
    params: queries.orderTransferDetail(
      formatSimpleParams(
        {
          referenceId: null,
        },
...
export const pendingTransfers =
  ...
  dispatch => {
    fetch({
      ...
      onSuccess: res => {
        const count =
          res && res.listOrderTransfers && res.listOrderTransfers.totalCount
            ? res.listOrderTransfers.totalCount
            : 0
...
export const pendingReceivables =
  ...
  dispatch => {
    fetch({
      ...
      onSuccess: res => {
        const count =
          res && res.listOrderReceivables && res.listOrderReceivables.totalCount
            ? res.listOrderReceivables.totalCount
            : 0
        successCallback(count)
      },
    })
...
export const updateOrderTransferStatus =
...
export const searchLandlordList =
...
export const listOrderReceivables = params => dispatch => {
  fetch({
    dispatch,
    endpoint: endpoints.defaultUrl.url(),
    params: queries.listOrderReceivables(
      formatSimpleParams(
        {
          pageNumber: 1,
          pageSize: 10,
...
export const updateOrderReceivable =
  (params, successCallback = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
      ...
      onSuccess: res => {
        successCallback(res)
        message.success(
          i18n.t(`cms.billing.tarnsfer.receivable.success.${params.status.toLowerCase()}.tips`),
        )
      },
      onError: () => {
        message.error(i18n.t('cms.properties.edit.toast.error'))
...
export const listOrderRefunds = params => dispatch => {
  fetch({
    dispatch,
    endpoint: endpoints.defaultUrl.url(),
    params: queries.listOrderRefunds(
      formatSimpleParams(
        {
          pageNumber: 1,
          pageSize: 10,
...
export const orderRefund = params => dispatch => {
  ...
  fetch({
    dispatch,
    endpoint: endpoints.defaultUrl.url(),
    params: queries.orderRefundDetail(
      formatSimpleParams(
        {
          referenceId: null,
        },
...
export const pendingRefunds =
  ...
  dispatch => {
    fetch({
      ...
      onSuccess: res => {
        const count =
          res && res.listOrderRefunds && res.listOrderRefunds.totalCount
            ? res.listOrderRefunds.totalCount
            : 0
        successCallback(count)
      },
    })
