...
export const getLandlordContacts =
  (params, onSuccess = () => {}) =>
  dispatch => {
    ...
    fetch({
      dispatch,
      endpoint: endpoints.getGeneralUrl.url(),
      params: queries.getLandlordContacts(
        formatSimpleParams(
          {
            pageNumber: 1,
            pageSize: 999,
...
export const getLandlordContactProperty =
  (params, onSuccess = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
      endpoint: endpoints.getGeneralUrl.url(),
      params: queries.getLandlordContactProperty(
        formatSimpleParams(
          {
            pageNumber: 1,
            pageSize: 1,
...
export const createLandlordContact =
  (params, successCallback = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
      endpoint: endpoints.getGeneralUrl.url(),
      params: queries.createLandlordContact(
        formatSimpleParams(
          {
            email: null,
            firstName: null,
...
export const updateLandlordContact =
  (params, successCallback = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
