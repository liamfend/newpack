...
export const getDistinctions = (propertySlug, params) => (dispatch) => {
  fetch({
    ...
    params: queries.distinctionsList(formatSimpleParams(
      {
        propertySlug: null,
        pageNumber: 1,
        pageSize: 10,
...
export const createDistinction = params => (dispatch) => {
  fetch({
    ...
    params: queries.createDistinction(formatSimpleParams(
      {
        propertyId: null,
        distinctionId: null,
        landlordValue: null,
...
export const updateDistinction = params => (dispatch) => {
  fetch({
    ...
    params: queries.updateDistinction(formatSimpleParams(
      {
        id: null,
        distinctionId: null,
        landlordValue: null,
