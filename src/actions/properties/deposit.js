...
export const updatePropertyPaymentsEnabled =
  (params, successCallback = () => {}) =>
  dispatch => {
    fetch({
      dispatch,
      ...
      onSuccess: () => {
        ...
        message.success(
          i18n.t(
            `cms.deposit_and_fees.update_property.book_now_${
              params.paymentsEnabled ? 'enable' : 'disable'
            }_success.tips`,
          ),
        )
      },
...
export const getPropertyDepositePayment =
