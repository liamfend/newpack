...
export const getPropertyList =
  ...
  dispatch => {
    ...
    if (isLandlordRole()) {
      if (!params.statuses || (params.statuses && params.statuses.indexOf('NEW') !== -1)) {
        ...
        formatSimpleParams(
          {
            ...
            sortBy: sort,
            sortDirection:
              sort === sortByMapping.NAME
                ? sortDirectionMapping.ascend
                : sortDirectionMapping.descend,
            countrySlug: null,
            citySlug: null,
            landlordSlug: null,
            statuses: null,
