  ...
  render() {
    const uploadProps = {
      ...
      beforeUpload: file => {
        ...
        axios
          .post(`${endpoints.updateContractFile.url()}`, formData, {
            headers: {
    ...
    return (
      <div className="contract-upload">
        <If condition={this.props.files && this.props.files.length > 0}>
          <Upload {...uploadProps}>{this.uploadButton()}</Upload>
        </If>
        <If condition={this.props.files && this.props.files.length === 0}>
          <Upload.Dragger {...uploadProps}>
            ...
            <div className="contract-upload__upload-content">
              <p className="contract-upload__upload-text">
                {this.props.t('cms.contract.upload.tips.text')}
              </p>
