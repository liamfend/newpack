...
export default class TenancyDetailsPreview extends React.PureComponent {
  ...
  isShowLogic = () => {
    this.setState(this.state, () => {
      ...
      this.setState({
        ...
        moveInPreviewDesc: tenancy.moveInPreview,
  ...
  render() {
    ...
    const tendencyCheck = this.props.showPlaceHolder;
    return (
      <div className="tenancy-details-preview">
        <If condition={ !tendencyCheck }>
          <div className="tenancy-details-preview__view-on-student-com">
              ...
              title={ () => (<div>
                <If condition={ !this.props.showPlaceHolder }>
                  ...
                  <div className="listing-model">
                    <div className="listing-model__line">
                      <If condition={ this.state.moveInPreviewDesc }>
                        <span className="listing-model__desc listing-model__move-in-desc">
                          { `${this.props.t('cms.listing.edit.tenancy_preview.move_in')} ${this.state.moveInPreviewDesc}` }
                        </span>
                      </If>
                      <If condition={ this.state.moveInPreviewDesc && this.state.moveOutDesc }>
                      ...
                      <If condition={ this.state.moveOutDesc }>
                        <span className="listing-model__desc listing-model__move-out-desc">
                          { `${this.props.t('cms.listing.edit.tenancy_preview.move_out')} ${this.state.moveOutDesc}` }
                        </span>
                      </If>
                    </div>
            ...
            >
              <p className="tenancy-details-preview__view-on-student-com-content" ref={ (node) => { this.previewTooltip = node; } }>
                {
        ...
        <If condition={ !this.props.showTitle }>
          <div className="tenancy-details-preview__container">
            <div className="tenancy-details-preview__desc tenancy-details-preview__move-in-desc">
              <p className="tenancy-details-preview__desc-label">{ this.props.t('cms.listing.edit.tenancy_preview.move_in') }</p>
            ...
            <div className="tenancy-details-preview__desc tenancy-details-preview__tenancy-desc">
              <p className="tenancy-details-preview__desc-label">{ this.props.t('cms.listing.edit.tenancy_preview.stay') }</p>
            ...
            <div className="tenancy-details-preview__desc tenancy-details-preview__move-out-desc">
              <p className="tenancy-details-preview__desc-label">{ this.props.t('cms.listing.edit.tenancy_preview.move_out') }</p>
...
TenancyDetailsPreview.propTypes = {
  ...
  tenancyType: PropTypes.oneOf(['EQUALS', 'NO_LESS_THAN', 'NO_MORE_THAN', 'BETWEEN', 'NOT_SPECIFIC', '']),
