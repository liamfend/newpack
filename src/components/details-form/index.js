...
class DetailsForm extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={ classNames('details-form', this.props.className, {
        ...
        <Form className="details-form__form">
          <Row gutter={ 100 }>
            <Col span={ 12 }>
              ...
              <Form.Item>
                <label className="details-form__label details-form__label--disabled">
                  { this.props.t(`cms.edit.details.label.${this.props.type === 'City' ? 'country' : 'city'}`) }
                </label>
              ...
              <Form.Item>
                ...
                {getFieldDecorator('rank', {
                  ...
                  <InputNumber className="details-form__rank-input" min={ 0 } max={ 1000 } placeholder="0~1000" />,
                )}
              </Form.Item>
              ...
              <If condition={ this.props.type === 'University' }>
                ...
                <Form.Item>
                  { getFieldDecorator('commonNames', {
                    ...
                    <TagTextArea
                      contentList={ this.props.data && this.props.data.commonNames ?
                        this.props.data.commonNames : []
                      }
                      t={ t }
                      countLimit={ 10 }
                      tagLengthLimit={ 100 }
                      placeholder={ t('cms.location.table.university.details.common_names.placeholder') }
                ...
                <div>
                  {
                    getFieldDecorator('coordinates', {
                      ...
                      <MyMap
                        ...
                        countryName={ this.props.data && this.props.data.country ?
                          this.props.data.country.name : '' }
                        cityName={ this.props.data && this.props.data.city ?
