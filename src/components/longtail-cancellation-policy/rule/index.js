...
import {
  withInRules,
  allcancellationTrans,
  longtailCancellationPeriod,
} from '~helpers/longtail-cancellation-period'
    ...
    return (
      <div className="free-cancellation-policy-rule">
        <If condition={this.content}>
          ...
          >
            <h3 className="free-cancellation-policy-rule__card-title">{t(this.content.title)}</h3>
                  ...
                  <div className="free-cancellation-policy-rule__rule" key={rule}>
                    <div className="free-cancellation-policy-rule__img">
                      <Icon
                        ...
                        className={classNames('free-cancellation-policy-rule__icon', {
                          'free-cancellation-policy-rule__icon--close':
                            withInRules[rule].icon === 'close',
                        })}
                      />
                    </div>
                    <span className="free-cancellation-policy-rule__lable">
                      ...
                      <If condition={withInRules[rule].tip}>
                        <Tooltip placement="top" title={t(withInRules[rule].tip)}>
                          <Icon
                            type="question-circle"
                            className="free-cancellation-policy-rule__tooltip-icon"
                          />
                        </Tooltip>
                      </If>
                    </span>
