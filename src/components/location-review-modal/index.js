  ...
  generateDescription = (label, value, tab) => (
    <tr className="location-review__description" key={ label }>
      ...
      <Choose>
          ...
          <td className="location-review__description-item">
            ...
            <If condition={ this.props.data.smallHeroImage }>
              <img
                className="location-review__img"
                src={ imageUrl(
                  this.props.data.smallHeroImage,
                  imageSizes.smallHeroImageThumbnail,
                ) }
        ...
        <Otherwise><td className="location-review__description-item">{ value || '-' }</td></Otherwise>
      </Choose>
    </tr>
  );
    ...
    return (
      <div className={ classNames('location-review') }>
        <div className="location-review__header">
          <h3 className="location-review__header-title">{ t('cms.edit.review_modal.review_your_edition') }</h3>
          <Icon
            type="close"
            ...
            <Choose>
              <When condition={ !this.props.isHomeList }>
                <button
                  ...
                  onClick={ () => { this.handleEdit(locationTabType.DETAILS); } }
                >
                  ...
                  <table className="location-review__details-table location-review__details-table--details">
                    <tbody>
                      ...
                      <If condition={ type === locationType.CITY_TYPE }>
                        { this.generateDescription('country', data.country ? data.country.name : '', 'details') }
                      </If>
                      <If condition={ type !== locationType.CITY_TYPE }>
                        { this.generateDescription('city', data.city ? data.city.name : '', 'details') }
                      </If>
            ...
            <Choose>
              <When condition={ !this.props.isHomeList }>
                <button
                  type="button"
                  className="location-review__edit-btn"
                  onClick={ () => { this.handleEdit(locationTabType.CONTENT); } }
                >
                  { t('cms.edit.review_modal.btn.edit') }
                </button>
              </When>
                ...
                <Col span={ 24 }>
                  <table className="location-review__details-table">
                    <tbody>
                      ...
                      { this.generateDescription('hero_image', data.country ? data.country.name : '', 'content') }
                    </tbody>
                  </table>
                </Col>
              </Row>
            ...
            <Choose>
              <When condition={ !this.props.isHomeList }>
                <button
                  type="button"
                  className="location-review__edit-btn"
                  onClick={ () => { this.handleEdit(locationTabType.SEO); } }
                >
                  { t('cms.edit.review_modal.btn.edit') }
                </button>
              </When>
        ...
        <div className="location-review__btn-container" ref={ (node) => { this.btnContainer = node; } }>
          ...
          >
            <If condition={ !data.published && !this.props.isHomeList }>
              ...
              <button type="button" className="location-review__btn location-review__btn--fill" onClick={ this.handlePublish }>
            ...
            <If condition={ data.published && !this.props.isHomeList }>
              ...
              <button type="button" className="location-review__btn location-review__btn--fill" onClick={ this.handleSave }>
