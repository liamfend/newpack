 ...
 * class YourComponent {}
 */
const modal = (options = {}, isSticky = false) => Component =>
  class extends React.Component {
    ...
    active = () => {
      if (this.props.element) {
        ...
        if (isSticky) { this.setModalBodyScroll(); }
        this.setModalOffset();
      }
    };
    ...
    inactive = () => {
      if (this.props.element) {
        ...
        this.scrollTop = null;
        if (isSticky) { this.cancelModalBodyScroll(); }
      }
    };
    ...
    render() {
      return (
        <div
          ref={ (modalwraper) => { this.modal = modalwraper; } }
