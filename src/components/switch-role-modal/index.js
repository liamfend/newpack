...
export default class SwitchRoleModal extends React.Component {
  constructor() {
    ...
    this.availableRoleList = [
      'admin', 'pms_landlord', 'content_manager', 'content_manager_level_2',
      'regional_supply_head', 'supply', 'financial',
    ];
  }

  handleRoleConfirm = () => {
    const { pathname } = this.props.location;
    if (pathname.includes('account/account-management') && this.state.selectedRole === 'content_manager_level_2') {
    ...
    if (this.state.selectedRole) {
      ...
      this.props.onClose();
      message.success(this.props.t('cms.switch_role_modal.success_message', {
    ...
    if (['financial', 'admin'].indexOf(this.state.selectedRole) === -1 && pathname.includes('billing')) {
  ...
  render() {
    if (!(this.props.authList.identity
        ...
        <div className="switch-role-modal__container">
          <div className="switch-role-modal__position-container">
            <div className="switch-role-modal__header-container">
              ...
              <button className="switch-role-modal__btn switch-role-modal__btn--close" onClick={ this.props.onClose }>
            ...
            <div className="switch-role-modal__content-container">
              <div className="switch-role-modal__role-list">
                ...
                >
                  <For each="role" index="index" of={ this.props.authList.identity.identity.frontendScopes }>
                    <If condition={ this.availableRoleList.indexOf(role.role) !== -1 }>
                      ...
                      >{ this.props.t(`cms.switch_role_modal.role.${role.role}`) }</Radio>
                    </If>
