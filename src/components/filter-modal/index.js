      ...
      if (!error && this.state.editFilter) {
        if (this.state.editFilter === 'log_date') {
          ...
          if (this.state.editFilter === 'change_by') {
            data.operator2 = this.props.cmsUserList.find(
              user => user.email === values[`${this.state.editFilter}_operator2`],
            )
          }
    ...
    return (
      <div className="filter-modal">
        <div className="filter-modal__body">
          ...
          <div
            className="filter-modal__filter-btn-container"
            ref={node => {
              this.filterBtnContainer = node
            }}
          >
              ...
              <Form>
                <Form.Item className="filter-modal__form-item">
                  ...
                  {getFieldDecorator('filter_name', {
                    initialValue: this.props.t(
                      `cms.properties.change_log.filter_type.${this.state.editFilter}`,
                    ),
                        ...
                        {getFieldDecorator('start_date', {
                          ...
                          rules: [
                            {
                              validator: (rule, value, callback) => {
                                if (!value && !this.props.form.getFieldValue('end_date')) {
                                  callback(
                                    this.props.t(
                                      'cms.properties.change_log.filter_modal.error_msg.select_a_date',
                                    ),
                                  )
                                } else {
                                  callback()
                          ...
                          <DatePicker
                            ...
                            placeholder={this.props.t(
                              'cms.properties.change_log.filter_modal.label.start_date',
                            )}
                      ...
                      <Form.Item className="filter-modal__form-item">
                        {getFieldDecorator('end_date', {
                          ...
                          <DatePicker
                            ...
                            format="YYYY-MM-DD"
                            placeholder={this.props.t(
                              'cms.properties.change_log.filter_modal.label.end_date',
                            )}
                    ...
                    {getFieldDecorator('operator1', {
                      ...
                      <Select className="filter-modal__select">
                        <Select.Option key="equals">
                          {this.props.t(
                            'cms.properties.change_log.filter_modal.operate_1_value.equals',
                          )}
                        </Select.Option>
                      </Select>,
                    )}
                  ...
                  <Form.Item className="filter-modal__form-item">
                    ...
                    <If condition={this.state.editFilter === 'log_section'}>
                      {getFieldDecorator('log_section_operator2', {
                        rules: [
                          {
                            ...
                            message: this.props.t(
                              'cms.properties.change_log.filter_modal.error_msg.no_empty',
                            ),
                          },
                        ],
                      })(
                        <Select
                          placeholder={this.props.t(
                            'cms.properties.change_log.filter_modal.placeholder.log_section',
                          )}
                          className="filter-modal__select"
                        >
                          <Select.Option key="details">
                            {this.props.t(
                              'cms.properties.change_log.filter_modal.log_section_value.details',
                            )}
                          </Select.Option>
                          <Select.Option key="address">
                            {this.props.t(
                              'cms.properties.change_log.filter_modal.log_section_value.address',
                            )}
                          </Select.Option>
                          <Select.Option key="facility">
                            {this.props.t(
                              'cms.properties.change_log.filter_modal.log_section_value.facility',
                            )}
                          </Select.Option>
                          <Select.Option key="rooms">
                            {this.props.t(
                              'cms.properties.change_log.filter_modal.log_section_value.rooms',
                            )}
                          </Select.Option>
                          <Select.Option key="listings">
                            {this.props.t(
                              'cms.properties.change_log.filter_modal.log_section_value.listings',
                            )}
                          </Select.Option>
                        </Select>,
                      )}
                    ...
                    <If condition={this.state.editFilter === 'change_by'}>
                      {getFieldDecorator('change_by_operator2', {
                        ...
                        <Select
                          placeholder={this.props.t(
                            'cms.properties.change_log.filter_modal.placeholder.user_email',
                          )}
                          className="filter-modal__select"
                        >
            ...
            <div className="filter-modal__filters-container">
              <For of={this.state.filters} each="filter">
                <FilterCard
                  ...
                  filter={filter}
                  onClose={() => {
                    this.handleRemoveFilter(filter.filterType)
                  }}
                  t={this.props.t}
                />
              </For>
            ...
            <When condition={this.state.editFilter}>
              <Popover
                content={this.props.t(
                  'cms.properties.change_log.filter_modal.reminder.confirm_editing',
                )}
                placement="topRight"
              >
