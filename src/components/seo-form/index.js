...
class SEOForm extends React.Component {
  ...
  textCounter = (text, limit) => {
    ...
    return (
      <div
        className={classNames('seo-form__counter', {
    ...
    return (
      <div className={classNames('seo-form', this.props.className)}>
        <Form className="seo-form__form">
          <Row>
            <p className="seo-form__summary">{this.props.t('cms.edit.seo.summary.tips')}</p>
          </Row>
          <Row gutter={100}>
            <Col span={12}>
              ...
              <div className="seo-form__headline-container">
                ...
                <Form.Item
                  ...
                  ref={node => {
                    this.srpIntroHeadlineEnabled = node
                  }}
                >
                  {getFieldDecorator('srpIntroHeadlineEnabled', {
                    ...
                    <Checkbox
                      onChange={() => {
                        this.handleTemplateEnabledChange('srpIntroHeadline')
                      }}
                    >
                      <Tooltip
                        trigger="hover"
                ...
                <Form.Item className="seo-form__item-container">
                  <div
                    className="seo-form__tips-container"
                    ref={node => {
                      this.seoHeadlineContainer = node
                    }}
                  >
                    <Tooltip
                      {...this.getTooltipData(
                        this.seoHeadlineContainer,
                        getFieldValue('srpIntroHeadlineEnabled'),
                      )}
                    >
                      {getFieldDecorator('srpIntroHeadline', {
                        initialValue:
                          this.props.data && !getFieldValue('srpIntroHeadlineEnabled')
                            ? this.props.data.srpIntroHeadline
                            : this.props.t('cms.edit.seo.input.disabled.placeholder'),
                        rules: [
                          {
                              ...
                              if (!value || value.length > 100) {
                                callback(
                                  !value
                                    ...
                                    : this.props.t(
                                        'cms.properties.edit.error.format_error_message',
                                      ),
                                )
                              } else {
                                callback()
                        ...
                        <Input
                          ...
                          disabled={getFieldValue('srpIntroHeadlineEnabled')}
                        />,
                      )}
                    </Tooltip>
                  </div>
              ...
              <div className="seo-form__paragraph-container">
                ...
                <Form.Item className="seo-form__checkbox-container">
                  {getFieldDecorator('srpIntroParagraphEnabled', {
                    ...
                    <Checkbox
                      onChange={() => {
                        this.handleTemplateEnabledChange('srpIntroParagraph')
                      }}
                    >
                      <Tooltip
                        trigger="hover"
                ...
                <Form.Item className="seo-form__item-container">
                  <div
                    className="seo-form__tips-container"
                    ref={node => {
                      this.seoParagraphContainer = node
                    }}
                  >
                    <Tooltip
                      {...this.getTooltipData(
                        this.seoParagraphContainer,
                        getFieldValue('srpIntroParagraphEnabled'),
                      )}
                    >
                      {getFieldDecorator('srpIntroParagraph', {
                        initialValue:
                          this.props.data && !this.props.data.srpIntroParagraphEnabled
                            ? this.props.data.srpIntroParagraph
                            : this.props.t('cms.edit.seo.input.disabled.placeholder'),
                        rules: [
                          {
            ...
            <Col span={12}>
              <h3 className="seo-form__block-title">
                {this.props.t('cms.edit.seo.block.title.meta', {
                  type: this.props.type,
                })}
              </h3>
              <div className="seo-form__meta-title-container">
                ...
                <Form.Item className="seo-form__checkbox-container">
                  {getFieldDecorator('metaTitleEnabled', {
                    ...
                    <Checkbox
                      onChange={() => {
                        this.handleTemplateEnabledChange('metaTitle')
                      }}
                    >
                      <Tooltip
                        trigger="hover"
                ...
                <Form.Item className="seo-form__item-container">
                  <div
                    className="seo-form__tips-container"
                    ref={node => {
                      this.seoMetaTitleContainer = node
                    }}
                  >
                    <Tooltip
                      {...this.getTooltipData(
                        this.seoMetaTitleContainer,
                        getFieldValue('metaTitleEnabled'),
                      )}
                    >
                      {getFieldDecorator('metaTitle', {
                        initialValue:
                          this.props.data && !this.props.data.metaTitleEnabled
              ...
              <div className="seo-form__meta-desc-container">
                ...
                <Form.Item className="seo-form__checkbox-container">
                  {getFieldDecorator('metaDescriptionEnabled', {
                    ...
                    <Checkbox
                      onChange={() => {
                        this.handleTemplateEnabledChange('metaDescription')
                      }}
                    >
                      <Tooltip
                        trigger="hover"
                ...
                <Form.Item className="seo-form__item-container">
                  <div
                    className="seo-form__tips-container"
                    ref={node => {
                      this.seoMetaDescriptionContainer = node
                    }}
                  >
                    <Tooltip
                      {...this.getTooltipData(
                        this.seoMetaDescriptionContainer,
                        getFieldValue('metaDescriptionEnabled'),
                      )}
                    >
                      {getFieldDecorator('metaDescription', {
                        initialValue:
                          this.props.data && !this.props.data.metaDescriptionEnabled
                            ? this.props.data.metaDescription
                            : this.props.t('cms.edit.seo.input.disabled.placeholder'),
                        rules: [
                          {
              ...
              <div className="seo-form__meta-keywords-container">
                ...
                <Form.Item className="seo-form__checkbox-container">
                  {getFieldDecorator('metaKeywordsEnabled', {
                    ...
                    <Checkbox
                      onChange={() => {
                        this.handleTemplateEnabledChange('metaKeywords')
                      }}
                    >
                      <Tooltip
                        trigger="hover"
                ...
                <Form.Item className="seo-form__item-container">
                  <div
                    className="seo-form__tips-container"
                    ref={node => {
                      this.seoMetaKeywordsContainer = node
                    }}
                  >
                    <Tooltip
                      {...this.getTooltipData(
                        this.seoMetaKeywordsContainer,
                        getFieldValue('metaKeywordsEnabled'),
                      )}
                    >
                      {getFieldDecorator('metaKeywords', {
                        initialValue:
                          this.props.data && !this.props.data.metaKeywordsEnabled
                            ? this.props.data.metaKeywords
                            : this.props.t('cms.edit.seo.input.disabled.placeholder'),
                        rules: [
                          {
