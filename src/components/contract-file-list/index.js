      ...
      <div className="contract-file-list">
        <For each="file" index="index" of={this.props.files}>
          <Choose>
            <When
              condition={
                file.contentType === 'application/pdf' || file.content_type === 'application/pdf'
              }
            >
              <Tooltip
                key={index}
              ...
              >
                <div
                  className="contract-file-list__tooltips-container"
                  ref={node => {
                    this.fileContainer[index] = node
                  }}
                >
                  <div className="contract-file-list__file-container">
                    <a
                      href={this.buildAuthContractUrl(file.source)}
                      target="_blank"
            ...
            <Otherwise>
              <div className="contract-file-list__img-container" key={index}>
                ...
                >
                  <img
                    className="contract-file-list__img"
                    src={this.buildAuthContractUrl(file.source)}
                    alt={file.name}
                  />
                </a>
              </div>
