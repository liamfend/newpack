    ...
    this.setState(
      ...
      () =>
        confirm({
          ...
          content:
            this.props.contentType && this.props.contentType === 'create'
              ? this.props.t('cms.properties.create.leave_alert.content')
              : this.props.t('cms.properties.edit.leave_alert.content'),
          ...
          onOk: () => {
            this.handleConfirmNavigationClick(location)
          },
        }),
    )
  }
