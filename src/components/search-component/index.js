...
export default class searchComponent extends React.Component {
  ...
  handleItemClick = (item) => {
    ...
    const selectItems = this.props.options.filter(option =>
      this.state.selectList.indexOf(option[this.props.keyValue]) !== -1,
    );
      ...
      >
        <div className="search-component__input-container">
          <input
            ...
            placeholder={ this.props.t('cms.global.search_component.placeholder.please_input_search_content_here') }
        ...
        <Choose>
          ...
          <Otherwise>
            ...
            <div className="search-component__operate-container">
              <button type="button" className="search-component__btn search-component__btn--clear" onClick={ this.handleClear }>
                { this.props.t('cms.global.search_component.clear_selected') }
              </button>
              <If condition={ this.props.showSelectAll }>
                <button type="button" className="search-component__btn search-component__btn--select-all" onClick={ this.handleSelectAll }>
