...
import {
  locales, operateType, offerTypes, tenancyUnitTypes,
  offerType, platformEntity, entityAction } from '~constants';
...
class Content extends React.Component {
  ...
  formatDiscount = (value) => {
    if (this.props.form.getFieldValue('offerType') === discount && !value.toString().match('%')) {
      return `${value}%`;
    } else if (this.props.form.getFieldValue('offerType') === discount && value.toString().match('%')) {
      return value;
    }
  ...
  render() {
    ...
    return (<div>
      <Card className="create-offer__card">
        <Form onSubmit={ this.handleSubmit } layout="vertical">
          <Col span={ 12 } style={ { paddingRight: 50 } }>
            <FormItem label={ this.props.t('cms.special_offer.form.offer_title') }>
              { getFieldDecorator('internalTitle', {
                ...
                rules: [
                  { required: true, message: this.props.t('cms.special_offer.error.form.offer_title') },
                ],
              })(
            ...
            <FormItem label={ this.props.t('cms.special_offer.form.notes') }>
              { getFieldDecorator('notes', {
                ...
                rules: [
                  { message: this.props.t('cms.special_offer.error.form.notes') },
                ],
              })(
                <Input placeholder={ this.props.t('cms.special_offer.form.placeholder') } />,
              )}
            ...
            <FormItem label={ this.props.t('cms.special_offer.form.instructions') }>
              { getFieldDecorator('fulfillmentInstructions', {
                ...
                rules: [
                  { message: this.props.t('cms.special_offer.error.form.instructions') },
                ],
              })(
                <TextArea placeholder={ this.props.t('cms.special_offer.form.placeholder') } autosize={ { minRows: 2, maxRows: 6 } } />,
              )}
            </FormItem>
            ...
            <FormItem label={ this.props.t('cms.special_offer.form.description') } >
              { getFieldDecorator('description', {
                ...
                rules: [
                  { required: true, message: this.props.t('cms.special_offer.error.form.description') },
                ],
              })(
                <ReactQuill
                ...
                <FormItem style={ { paddingRight: 8 } }>
                  { getFieldDecorator('minTenancyValue', {
                    ...
                    <InputNumber
                      ...
                      max={ 999999 }
                      precision={ 0 }
                      placeholder={ this.props.t('cms.special_offer.form.tenancy_length.placeholder') }
                    />,
                  )}
                </FormItem>
              </Col>
          ...
          <Col span={ 12 } style={ { paddingLeft: 50 } }>
            <Row>
              <Col span={ 12 }>
                <FormItem label={ this.props.t('cms.special_offer.form.type') } style={ { paddingRight: 8 } }>
              ...
              <Col span={ 12 }>
                <FormItem label={ this.props.t('cms.special_offer.form.amount') } style={ { paddingLeft: 8 } }>
            ...
            <FormItem label={ this.props.t('cms.special_offer.form.language') }>
              { getFieldDecorator('locales', {
                ...
                rules: [
                  { required: true, message: this.props.t('cms.form.error.locales') },
                ],
              })(
                <Checkbox.Group className="create-offer-content__checkbox" options={ localeOptions } />,
              )}
            </FormItem>
            <div className="create-offer-content__select-all">
              <a tabIndex="0" role="button" onClick={ this.chooseAll } className="create-offer-content__text-underline">Select All</a>
              <Divider type="vertical" />
              <a tabIndex="0" role="button" onClick={ this.clearAll } className="create-offer-content__text-underline">Clear All</a>
            </div>
      ...
      >
        <Button type="primary" className="create-offer-content__continue-save-btn" onClick={ this.onContinue } >
