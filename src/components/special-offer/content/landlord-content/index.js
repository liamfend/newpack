...
import { locales, operateType, offerTypes, offerType, platformEntity, entityAction } from '~constants';
          ...
          <Col span={ 12 }>
            <FormItem label={ this.props.t('cms.special_offer.form.landlord_offer_title') }>
              { getFieldDecorator('title', {
                ...
                <Input placeholder={ this.props.t('cms.special_offer.form.placeholder') } className="create-offer-content__input" />,
              )}
            </FormItem>
            <FormItem label={ this.props.t('cms.special_offer.form.description') }>
              { getFieldDecorator('description', {
                ...
                <TextArea placeholder={ this.props.t('cms.special_offer.form.placeholder') } className="create-offer-content__input" autosize={ { minRows: 2, maxRows: 6 } } />,
              )}
            </FormItem>
            <Row>
              <Col span={ 12 }>
