      ...
      <div className="no-virtual-tour-link">
        <Choose>
          <When condition={section !== 'Overall'}>
            {t('cms.properties.edit.gallery.no_virtual_tour_link', {
              section: section.toLowerCase(),
            })}
          </When>
          <Otherwise>{t('cms.properties.edit.gallery.no_overall_virtual_tour_link')}</Otherwise>
        </Choose>
        <span
          className="add-virtual-tour-link"
          onClick={() => {
