          ...
          <Choose>
            <When condition={ this.state.status === 'success' }>
              <Svg
                ...
                hash={ this.state.failedNum === this.state.filesNum ? 'failed-error' : 'check-circle' }
              />
              <div className="mini-uploading-modal__text">
                <span className="mini-uploading-modal__success-text">{ this.state.successdNum }&nbsp;</span>
                <span>
                  { this.props.t('cms.properties.edit.gallery.mini_modal.files_succeed_text') }
                </span>
                <span className="mini-uploading-modal__hr">&nbsp;|&nbsp;</span>
                <span className="mini-uploading-modal__failed-text">{ this.state.failedNum }&nbsp;</span>
                <span >
