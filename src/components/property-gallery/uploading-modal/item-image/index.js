      ...
      <div className={ classNames('gallery-uploading__image', className) }>
        <div className="gallery-uploading__image-wrapper">
          ...
          <div
            className={
              classNames(
                'gallery-uploading__image-progress-wrapper',
                {
                  'gallery-uploading__image-progress-wrapper--success': status === uploadStatus.SUCCESS,
                  'gallery-uploading__image-progress-wrapper--in-progress': status === uploadStatus.IN_PROGRESS,
                  'gallery-uploading__image-progress-wrapper--failed': status === uploadStatus.FAILED || status === uploadStatus.EXCEED,
                },
              )
            }
          >
        ...
        <span className="gallery-uploading__image-title" title={ item.file.name }>{ item.file.name }</span>
      </div>
    );
  }
}
