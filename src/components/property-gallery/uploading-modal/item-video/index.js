...
export default class ItemVideo extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={classNames('gallery-uploading__video', {
      ...
      >
        <Choose>
          ...
          >
            <div className="gallery-uploading__loading">
              <Spin />
            </div>
          </When>
          <Otherwise>
            <div className="gallery-uploading__video-title">
              <span className="gallery-uploading__video-icon-wrapper">
                ...
                <If condition={this.props.item.status === uploadStatus.FAILED}>
                  <Icon
                    className="gallery-uploading__video-failed-icon"
                ...
                <div className="gallery-uploading__name">
                  ...
                  <span className="gallery-uploading__video-progress-value">
                    <Choose>
                      <When
                        condition={
                          [uploadStatus.IN_PROGRESS, uploadStatus.PAUSE].indexOf(
                      ...
                      <Otherwise>{item.progress}%</Otherwise>
                    </Choose>
                  </span>
                </div>
                <If
            ...
            <div className="gallery-uploading__video-operation">
              <If condition={this.props.item.status === uploadStatus.IN_PROGRESS}>
                <button
                  className="gallery-uploading__operation-button"
                  onClick={this.props.item.handlePause}
                >
              ...
              <If condition={this.props.item.status === uploadStatus.PAUSE}>
                <button
                  className="gallery-uploading__operation-button"
                  onClick={this.props.item.handleContinue}
                >
              ...
              <If condition={this.props.item.status === uploadStatus.FAILED}>
                <button
                  className="gallery-uploading__operation-button"
                  onClick={this.handleVideoRestart}
                >
