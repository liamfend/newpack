        ...
        <div className="gallery-slider-modal__container">
              ...
              <Choose>
                <When condition={getFileType(item.contentType) === 'video'}>
                  <Choose>
                    ...
                    >
                      <div
                        className="gallery-slider-modal__source-item gallery-slider-modal__source-item-player"
                        key={index}
                      >
                        <Player
                          ref={player => {
                    ...
                    <Otherwise>
                      ...
                      >
                        ...
                        <div className="gallery-slider-modal__img-video-compress gallery-slider-modal__img">
                          <Choose>
                            <When
                              condition={item.transcodedStatus === gallery.videoStatus.compressing}
                            >
                              <HourglassIcon className="gallery-slider-modal__img-video-icon" />
                            </When>
                            <When condition={item.transcodedStatus === gallery.videoStatus.error}>
                              <VideoFailedIcon className="gallery-slider-modal__img-video-icon" />
                            </When>
                            <Otherwise>
                              <Icon
                                className="gallery-slider-modal__img-video-icon"
                                type="video-camera"
                              />
                            </Otherwise>
                          </Choose>
                        ...
                        <span className="gallery-slider-modal__video-compress-text">
                          <Choose>
                            ...
                            >
                              {this.props.t(
                                'cms.properties.edit.gallery.preview.video.video_compress',
                              )}
                            </When>
                            <Otherwise>
                              {this.props.t(
                                'cms.properties.edit.gallery.preview.video.video_wait_compress',
                              )}
                            </Otherwise>
                          </Choose>
                        </span>
                ...
                <Otherwise>
                  <div key={index}>
                    <div className="gallery-slider-modal__source-item">
                      <img
                        className="gallery-slider-modal__source-img"
                        src={imageUrl(item, imageSizes.big)}
                        alt=""
                      />
                    </div>
                  </div>
            ...
            <Choose>
              <When condition={activeItem.status === galleryStatus.REJECTED}>
                <Popconfirm
                  ...
                  title={this.props.t(
                    'cms.pending_approval.double_confirm.delete_rejected_file.title',
                  )}
                  okText={this.props.t('cms.properties.edit.gallery.library.slider.confirm_delete')}
                  cancelText={this.props.t(
                    'cms.properties.edit.gallery.library.slider.cancel_delete',
                  )}
                >
          ...
          <div className="gallery-slider-modal__thumbnail-container">
            ...
            >
              <For each="item" of={list} index="index">
                <div
                  ...
                  role="button"
                  tabIndex="0"
                  className={classNames('gallery-slider-modal__thumbnail-item', {
                ...
                >
                  <Choose>
                    <When condition={getFileType(item.contentType) === 'video'}>
                      <Choose>
                        <When
                          condition={item.transcodedStatus === gallery.videoStatus.waitCompress}
                        >
                        ...
                        <Otherwise>
                          <div
                            className={classNames('gallery-slider-modal__img-video-compress', {
                              'gallery-slider-modal__img-video-compress-err':
                                item.transcodedStatus === gallery.videoStatus.error,
                            })}
                          >
                            <Choose>
            ...
            <div className="gallery-slider-modal__thumbnail-number">
              <span className="gallery-slider-modal__thumbnail-active-index">
