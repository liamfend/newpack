      ...
      <div className="listing-modal__availability-and-prices-input-container">
          ...
          <Row gutter={ 9 }>
            <Col span={ 12 }>
              <div className="listing-modal__column-container">
                <label className="listing-modal__label">{ t('cms.listing.modal.availability.label') }</label>
                <Form.Item>
                  <div ref={ (node) => { availabilityContainer = node; } }>
            ...
            <Col span={ 12 }>
              <div className="listing-modal__column-container">
                <label className="listing-modal__label listing-modal__label--required">{ t('cms.listing.modal.price_type.label') }</label>
                <Form.Item>
                  <div ref={ (node) => { priceTypeContainer = node; } }>
                    { getFieldDecorator('priceType', {
                      ...
                      >
                        <Option key="exact" value="exact">{ t('cms.listing.modal.price_type.option.exact') }</Option>
                        <Option key="range" value="range">{ t('cms.listing.modal.price_type.option.range') }</Option>
                      </Select>,
                    )}
                  </div>
        ...
        <div className="listing-modal__row-container">
          <Row gutter={ 9 }>
            <Col span={ 12 }>
              <div className="listing-modal__column-container">
                <label className="listing-modal__label listing-modal__label--required">{ t('cms.listing.modal.price_min.label') }
            ...
            <Col span={ 12 }>
              <div className="listing-modal__column-container">
                <label className="listing-modal__label">{ t('cms.listing.modal.price_max.label') }
                  <span className="listing-modal__label-currency"> ({ currency })</span>
                </label>
                <div className="listing-modal__price-input-container">
                  <Form.Item>
        ...
        <div className="listing-modal__row-container">
          <Row gutter={ 9 }>
            <Col span={ 12 }>
              <div className="listing-modal__column-container">
                <label className="listing-modal__label listing-modal__label--required">{ t('cms.listing.modal.discount_type.label') }</label>
                <Form.Item>
                  <div ref={ (node) => { discountTypeContainer = node; } }>
                    { getFieldDecorator('discountType', {
                      ...
                      >
                        <Option key="NO_DISCOUNT" value="NO_DISCOUNT">{ t('cms.listing.modal.discount_type.options.no_discount') }</Option>
                        <Option key="PERCENTAGE" value="PERCENTAGE">{ t('cms.listing.modal.discount_type.options.percentage') }</Option>
                        <Option key="ABSOLUTE" value="ABSOLUTE">{ t('cms.listing.modal.discount_type.options.fixed_amount') }</Option>
                      </Select>,
                    )}
                  </div>
                </Form.Item>
            ...
            <Col span={ 12 }>
              <div className="listing-modal__column-container">
                <label className="listing-modal__label">{ t('cms.listing.modal.discount_value.label') }</label>
                <div className="listing-modal__price-input-container">
                  <Form.Item>
                    { getFieldDecorator('discountValue', {
                      rules: [{
                        required: !showPlaceHolder && getFieldValue('discountType') !== 'NO_DISCOUNT',
                        message: t('cms.listing.modal.error_message.can_not_empty'),
                      },
                      {
                        ...
                        message: t('cms.listing.modal.error_message.discount_vale_bigger_than_price_min'),
                      }],
                    })(
        ...
        <div className="listing-modal__row-container">
          <Row gutter={ 9 }>
            <Col span={ 12 }>
              <div className="listing-modal__column-container">
                <label className="listing-modal__label">{ t('cms.listing.modal.original_price.label') }
                  <span className="listing-modal__label-currency"> ({ currency })</span>
                </label>
                <div className="listing-modal__price-input-container">
                  <Form.Item>
            ...
            <Col span={ 12 }>
              <div className="listing-modal__column-container">
                <label className="listing-modal__label">{ t('cms.listing.modal.current_price.label') }
                  <span className="listing-modal__label-currency"> ({ currency })</span>
                </label>
                <div className="listing-modal__price-input-container">
                  <Form.Item>
